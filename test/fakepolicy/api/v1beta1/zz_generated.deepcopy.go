...
func (in *FakePolicySpec) DeepCopyInto(out *FakePolicySpec) {
	*out = *in
	...
	in.TargetConfigMaps.DeepCopyInto(&out.TargetConfigMaps)
}
...
func (in *FakePolicyStatus) DeepCopyInto(out *FakePolicyStatus) {
	*out = *in
	...
	if in.DynamicSelectedConfigMaps != nil {
		in, out := &in.DynamicSelectedConfigMaps, &out.DynamicSelectedConfigMaps
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ClientSelectedConfigMaps != nil {
		in, out := &in.ClientSelectedConfigMaps, &out.ClientSelectedConfigMaps
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
